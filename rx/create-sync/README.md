# @[kingjs][@kingjs]/[rx][ns0].[create-sync][ns1]
The description.
## Usage
```js
var assert = require('assert');
var create = require('@kingjs/rx.create-sync');
...
```
$ npm install @kingjs/rx.create-sync
```
## Dependencies
|Package|Version|
|---|---|
...
## Source
https://repository.kingjs.net/rx/create-sync
## License
MIT

![Analytics](https://analytics.kingjs.net/rx/create-sync)

[@kingjs]: https://www.npmjs.com/package/kingjs
[ns0]: https://www.npmjs.com/package/@kingjs/rx
[ns1]: https://www.npmjs.com/package/@kingjs/rx.create-sync
